...
logging.basicConfig(filename='fileLog.log', filemode='w', encoding='utf-8', format=FORMAT, style='{', datefmt=DATEFMT,
                    level=logging.NOTSET)  # устанавливаем уровень журналирования NOTSET - уровень не установлен.
...
parser.add_argument('-height', type=int, nargs='?', default=1,
                    help='Высота прямоугольника')  # добавляем аргумент высота
...
r'''
примеры запуска:
py .\hw_python.py -width 22 -height 33
py .\hw_python.py -h
'''
